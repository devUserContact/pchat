...
this is the extent of `pchat`'s current functionality. if you happen to be an experienced rust programmer, 
i would greatly appereciate some pointers regauring best practices. 
